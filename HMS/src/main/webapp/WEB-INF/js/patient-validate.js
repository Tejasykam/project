function validate(){
	var count=0;
	if(!isValidPatientName() || !isValidEmail() || !isValidMobile()){
...
function isValidPatientName(){
	var nameInput = document.getElementById("patientname").value;
	var regex="^[a-zA-Z ]*$";
	if(nameInput.match(regex)){
		document.getElementById("p1").innerHTML = "";
		return true;
	}else{
		document.getElementById("p1").innerHTML = "<span style='color:#FF0000'>Invalid Patient Name</span>";
		return false;
	}
}
